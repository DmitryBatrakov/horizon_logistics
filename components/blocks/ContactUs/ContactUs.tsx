...
export const ContactUs = () => {
    return (
        <section
            id="contact"
            className="relative flex items-center justify-center w-full overflow-hidden bg-button py-20 px-4 md:py-28 scroll-mt-28"
        >
            ...
            <Reveal duration={0.3} delay={0.3} className="relative z-10 flex w-full max-w-7xl flex-col items-center justify-center gap-10">
                ...
                <Card className="w-full max-w-2xl rounded-lg border-0 bg-white py-0 shadow-2xl">
                    ...
                    <form className="grid grid-cols-1 gap-4 md:grid-cols-2">
                        ...
                        <button
                            type="submit"
                            className="col-span-full mt-1 h-12 rounded-md bg-button-foreground text-base font-bold text-button transition-opacity hover:opacity-90"
                        >
                            Submit Request
                        </button>
                    </form>
