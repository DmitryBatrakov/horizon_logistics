    ...
    return (
        <section className="w-full min-h-screen relative overflow-hidden">
            ...
            <div className="absolute inset-0 z-20 flex flex-col items-start justify-center max-w-7xl mx-auto w-full p-5 px-10 gap-8">
                ...
                >
                    <h1 className="text-md uppercase font-bold text-button-foreground  tracking-[0.16em]">
                        {t("titlePrefix")}
                    </h1>
                    <div className="text-white text-5xl md:text-8xl font-semibold  ">
                        {t("titleLine1")}
                    </div>
                    <div className="text-button-foreground text-5xl md:text-8xl font-semibold  mb-5 md:mb-10">
                        {t("titleLine2")}
                    </div>
