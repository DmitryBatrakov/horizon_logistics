...
export const Hero = () => {
    ...
    return (
        <section className="w-full min-h-screen relative overflow-hidden">
            ...
            <div className="absolute inset-0 z-20 flex flex-col items-center justify-center max-w-7xl mx-auto w-full p-5 px-4md:px-10 gap-8">
                <Reveal
                    className="flex flex-col items-start justify-start mt-20 w-full"
                >
                    ...
                    <div
                        className={cn(
                            "text-white text-[3.5rem] md:text-8xl font-semibold",
                            locale === "he" ? "text-[2.5rem]" : "text-[3rem]",
                        )}
                    >
                        {t("titleLine1")}
                    </div>
                    <div
                        className={cn(
                            "text-button-foreground text-[3.5rem] md:text-8xl font-semibold  mb-5 md:mb-10",
                            locale === "he" ? "text-[2.5rem]" : "text-[3rem]",
                        )}
                    >
                        {t("titleLine2")}
                    ...
                    <div className="flex justify-center md:justify-start items-center w-full mt-10">
                        <div className="flex gap-5">
                            <AnimatedButton text={t("cta")} href="/#contact" />
                        </div>
                    </div>
                </Reveal>
            </div>
